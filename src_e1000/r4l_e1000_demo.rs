...
struct E1000DrvPrvData {
    ...
    bars: i32,
    pci_dev_ptr: Arc<*mut bindings::pci_dev>,
}
...
impl pci::Driver for E1000Drv {
    ...
    fn probe(dev: &mut pci::Device, id: core::option::Option<&Self::IdInfo>) -> Result<Self::Data> {
        ...
        Ok(Box::try_new(E1000DrvPrvData {
            ...
            bars,
            pci_dev_ptr: Arc::try_new(dev.get_pci_dev_ptr())?,
        })?)
    }
    ...
    fn remove(data: &Self::Data) {
        ...
        unsafe {
            let dev_ptr = data.pci_dev_ptr.as_ref();
            bindings::pci_release_selected_regions(*dev_ptr, data.bars);
        };
    }
}
